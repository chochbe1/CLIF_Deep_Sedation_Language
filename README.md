...
* final_data folder - 54 total files - 2 data cleaning summaries, 2 LAPS2 missing summaries, 1 language count, 1 histogram, 1 primary analysis, 3 kappa tables, 20 sensitivity analyses, 19 secondary analyses, 5 subgroup analyses
* final_tables folder - 20 total files
* secondary_project folder - 63 files

## Detailed Instructions
1. Update json file in config folder with base directory, location to store project files, file type, and institution
