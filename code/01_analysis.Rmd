...
packages <- c("zoo", "data.table", "dplyr", "lubridate", "tidyr", "fst", "arrow", "table1", "lme4", "metafor", "yaml", "pscl", "MASS", "htmltools", "car", "WeightIt", "MatchIt", "purrr", "survival", "mediation", "cmprsk", "gfoRmula", "nnet", "medflex", "bruceR", "tidyverse", "survey", "ipw", "geepack", "broom", "forcats", "gtsummary", "tableone", "sandwich", "lmtest", "vcd", "psych")
...
#Basic Table One
# Generate the summary table grouped by language
eng_span_all_icu_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = english_spanish_all_icu_analysis, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
full_48hr_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = full_48hr_cohort, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
rass_2hrs_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = rass_2hrs_cohort, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
no_neuro_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = no_neuro_cohort, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
no_paralytic_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = no_paralytic_cohort, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
only_paralytic_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = only_paralytic_cohort, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
micu_only_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = micu_only_cohort, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
hispanic_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = hispanic_cohort, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
non_hispanic_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = non_hispanic_cohort, factorVars = catVars, test = TRUE)
...
#Basic Table One
# Generate the summary table grouped by language
language_reclass_table_one <- table1(~ age_at_admission + sex_category + ethnicity_category + race_category + bmi + laps2 + hospital_id + icu_type + imv_duration_days + thirty_day_mortality | language_category, data = language_reclass_cohort, factorVars = catVars, test = TRUE)
...
#Cohort wihout unknown patients
```{r}
...
#fit <- lm(percent_deep_sedation_48 ~ ethnicity_category + language_category, data = language_reclass_cohort)
#vif(fit)

library(vcd)
assocstats(table(no_unknown_ethnicity_cohort$ethnicity_category, no_unknown_ethnicity_cohort$language_category))

eth_lang_table <- table(language_reclass_cohort$ethnicity_category, language_reclass_cohort$language_category)
fisher.test(eth_lang_table)
```


#Sensitivity Analysis #9: English vs Non-English
```{r}
sensitivity_model_nine <- lm(percent_deep_sedation_48 ~ non_eng + race_category + ethnicity_category + age_category + sex_category + bmi + factor(hospital_icu_id) + elixhauser_score + SVM_SCORE + laps2,
               data = total_cohort)
...
```{r}
sensitivity_model_eighteen <- lm(percent_deep_sedation_48 ~ non_eng + ethnicity_category + race_category + age_category + sex_category + bmi + factor(hospital_icu_id) + elixhauser_score + SVM_SCORE + laps2,
