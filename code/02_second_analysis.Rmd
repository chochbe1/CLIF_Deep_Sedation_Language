...
packages <- c("zoo", "data.table", "dplyr", "lubridate", "tidyr", "fst", "arrow", "table1", "lme4", "metafor", "yaml", "pscl", "MASS", "htmltools", "car", "WeightIt", "MatchIt", "purrr", "survival", "mediation", "cmprsk", "gfoRmula", "nnet", "medflex", "bruceR", "tidyverse", "survey", "ipw", "geepack", "readr", "collapse", "stringr", "rprojroot", "jsonlite", "pROC", "caret", "tableone", "lmtest")
...
#config <- yaml::read_yaml("config/CLIF_Deep_Sedation_Language_config.yaml")
...
roc_obj_trach_one <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_one)

# Extract AUC
auc_value_trach_one <- pROC::auc(roc_obj_trach_one)
...
# Create ROC curve object
roc_obj_trach_two <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_two)

# Extract AUC
auc_value_trach_two <- pROC::auc(roc_obj_trach_two)
...
# Create ROC curve object
roc_obj_trach_three <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_three)

# Extract AUC
auc_value_trach_three <- pROC::auc(roc_obj_trach_three)
...
# Create ROC curve object
roc_obj_trach_four <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_four)

# Extract AUC
auc_value_trach_four <- pROC::auc(roc_obj_trach_four)
...
# Create ROC curve object
roc_obj_trach_five <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_five)

# Extract AUC
auc_value_trach_five <- pROC::auc(roc_obj_trach_five)
...
# Create ROC curve object
roc_obj_trach_six <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_six)

# Extract AUC
auc_value_trach_six <- pROC::auc(roc_obj_trach_six)
...
# Create ROC curve object
roc_obj_trach_seven <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_seven)

# Extract AUC
auc_value_trach_seven <- pROC::auc(roc_obj_trach_seven)
...
# Create ROC curve object
roc_obj_trach_eight <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_eight)

# Extract AUC
auc_value_trach_eight <- pROC::auc(roc_obj_trach_eight)
...
# Create ROC curve object
roc_obj_trach_nine <- pROC::roc(final_cohort$trached, final_cohort$predicted_prob_trach_nine)

# Extract AUC
auc_value_trach_nine <- pROC::auc(roc_obj_trach_nine)
...
# Create ROC curve object
roc_obj_death_one <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_one)

# Extract AUC
auc_value_death_one <- pROC::auc(roc_obj_death_one)
...
# Create ROC curve object
roc_obj_death_two <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_two)

# Extract AUC
auc_value_death_two <- pROC::auc(roc_obj_death_two)
...
# Create ROC curve object
roc_obj_death_three <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_three)

# Extract AUC
auc_value_death_three <- pROC::auc(roc_obj_death_three)
...
# Create ROC curve object
roc_obj_death_four <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_four)

# Extract AUC
auc_value_death_four <- pROC::auc(roc_obj_death_four)
...
# Create ROC curve object
roc_obj_death_five <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_five)

# Extract AUC
auc_value_death_five <- pROC::auc(roc_obj_death_five)
...
# Create ROC curve object
roc_obj_death_six <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_six)

# Extract AUC
auc_value_death_six <- pROC::auc(roc_obj_death_six)
...
# Create ROC curve object
roc_obj_death_seven <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_seven)

# Extract AUC
auc_value_death_seven <- pROC::auc(roc_obj_death_seven)
...
# Create ROC curve object
roc_obj_death_eight <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_eight)

# Extract AUC
auc_value_death_eight <- pROC::auc(roc_obj_death_eight)
...
# Create ROC curve object
roc_obj_death_nine <- pROC::roc(final_cohort$death_during_admission, final_cohort$predicted_prob_death_nine)

# Extract AUC
auc_value_death_nine <- pROC::auc(roc_obj_death_nine)
...
# Create ROC curve object
roc_obj_reintubation_one <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_one)

# Extract AUC
auc_value_reintubation_one <- pROC::auc(roc_obj_reintubation_one)
...
# Create ROC curve object
roc_obj_reintubation_two <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_two)

# Extract AUC
auc_value_reintubation_two <- pROC::auc(roc_obj_reintubation_two)
...
# Create ROC curve object
roc_obj_reintubation_three <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_three)

# Extract AUC
auc_value_reintubation_three <- pROC::auc(roc_obj_reintubation_three)
...
# Create ROC curve object
roc_obj_reintubation_four <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_four)

# Extract AUC
auc_value_reintubation_four <- pROC::auc(roc_obj_reintubation_four)
...
# Create ROC curve object
roc_obj_reintubation_five <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_five)

# Extract AUC
auc_value_reintubation_five <- pROC::auc(roc_obj_reintubation_five)
...
# Create ROC curve object
roc_obj_reintubation_six <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_six)

# Extract AUC
auc_value_reintubation_six <- pROC::auc(roc_obj_reintubation_six)
...
# Create ROC curve object
roc_obj_reintubation_seven <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_seven)

# Extract AUC
auc_value_reintubation_seven <- pROC::auc(roc_obj_reintubation_seven)
...
# Create ROC curve object
roc_obj_reintubation_eight <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_eight)

# Extract AUC
auc_value_reintubation_eight <- pROC::auc(roc_obj_reintubation_eight)
...
# Create ROC curve object
roc_obj_reintubation_nine <- pROC::roc(final_cohort$reintubation, final_cohort$predicted_prob_reintubation_nine)

# Extract AUC
auc_value_reintubation_nine <- pROC::auc(roc_obj_reintubation_nine)
